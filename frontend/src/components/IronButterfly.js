...
const CoveredCall = () => {
  ...
  const sendCoveredCall = async () => {
    try {
      const response = await axios.patch('http://localhost:8080/addIronButterfly',null, {
        params: {
  ...
  return (
    <div style={{display:'flex'}}>
                    <div>
                    <h1 style={{marginRight:'-500px'}}>Iron Butterfly Strategy</h1>
                    <div style={{backgroundColor:'#22272e'}}>
                    <h5 style={{position:'absolute', boxShadow: '0px 4px 6px rgba(0, 0, 0, 0.5)',left:'40px', borderRadius:'15px',  top:'315px', color:'#c5d1de', backgroundColor:'#22272e', padding:'15px', width:'650px'}}>Profit: (Current Price - Strike Price of Bought Call 1) - (Current Price - Strike Price of Sold Call 1) + (Current Price - Strike Price of Sold Call 2) - (Current Price - Strike Price of Bought Put 1) + (Current Price - Strike Price of Sold Put 2) - (Current Price - Strike Price of Bought Put 1) - Net Premium Paid
                ...
                <div>
                <h4>Enter predicted strike price</h4>
                <input 
                    type="number" 
                ...
                />
                        <h4>Enter predicted price range($)</h4>
