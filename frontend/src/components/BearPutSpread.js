...
const CoveredCall = () => {
  ...
  return (
    <div style={{display:'flex'}}>
                    ...
                    <h5 style={{position:'absolute', boxShadow: '0px 4px 6px rgba(0, 0, 0, 0.5)',left:'40px', borderRadius:'15px',  top:'300px', color:'#c5d1de', backgroundColor:'#22272e', padding:'15px', width:'650px'}}>Profit: (Strike Price of Bought Put - Strike Price of Sold Put) - (Current Price - Strike Price of Bought Put) - Net Premium Paid</h5>
